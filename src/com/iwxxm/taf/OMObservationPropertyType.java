...
/**
 * <p>OM_ObservationPropertyType complex type的 Java 类。
 * 
...
@XmlType(name = "OM_ObservationPropertyType", namespace = "http://www.opengis.net/om/2.0", propOrder = {
    "omObservation"
})
public class OMObservationPropertyType {

    @XmlElement(name = "OM_Observation")
