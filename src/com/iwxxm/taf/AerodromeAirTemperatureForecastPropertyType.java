...
/**
 * <p>AerodromeAirTemperatureForecastPropertyType complex type的 Java 类。
 * 
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://schemas.wmo.int/iwxxm/2.1}AerodromeAirTemperatureForecast"/>
 *       &lt;/sequence>
...
@XmlType(name = "AerodromeAirTemperatureForecastPropertyType", namespace = "http://schemas.wmo.int/iwxxm/2.1", propOrder = {
...
public class AerodromeAirTemperatureForecastPropertyType {
    ...
    /**
     * 获取aerodromeAirTemperatureForecast属性的值。
     * 
     * @return
     *     possible object is
    ...
    /**
     * 设置aerodromeAirTemperatureForecast属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link AerodromeAirTemperatureForecastType }
