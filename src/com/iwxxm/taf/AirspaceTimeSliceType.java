...
/**
 * <p>AirspaceTimeSliceType complex type的 Java 类。
 * 
...
@XmlType(name = "AirspaceTimeSliceType", namespace = "http://www.aixm.aero/schema/5.1.1", propOrder = {
    "rest"
})
    ...
    extends AbstractAIXMTimeSliceType
{
     ...
     * http://aixm.aero/schema/5.1.1_profiles/AIXM_WX/5.1.1a/AIXM_Features.xsd的第 226 行
    ...
    public static class Extension {
        ...
        @XmlElement(name = "AbstractAirspaceExtension", namespace = "http://www.aixm.aero/schema/5.1.1", required = true)
        protected AbstractExtensionType abstractAirspaceExtension;
        @XmlAttribute(name = "owns")
        protected java.lang.Boolean owns;

        /**
         * 获取abstractAirspaceExtension属性的值。
         * 
         * @return
         *     possible object is
        ...
        /**
         * 设置abstractAirspaceExtension属性的值。
         * 
         * @param value
         *     allowed object is
         *     {@link AbstractExtensionType }
