...
/**
 * <p>TAFPropertyType complex type的 Java 类。
 * 
 ...
 *         &lt;element ref="{http://schemas.wmo.int/iwxxm/2.1}TAF"/>
 *       &lt;/sequence>
...
@XmlType(name = "TAFPropertyType", namespace = "http://schemas.wmo.int/iwxxm/2.1", propOrder = {
    "taf"
})
public class TAFPropertyType {

    @XmlElement(name = "TAF")
    protected TAFType taf;
     ...
     *     
     */
    public void setTAF(TAFType value) {
        this.taf = value;
    }
