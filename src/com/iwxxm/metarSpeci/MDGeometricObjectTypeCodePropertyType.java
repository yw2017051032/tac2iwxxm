...
/**
 * <p>MD_GeometricObjectTypeCode_PropertyType complex type的 Java 类。
 * 
...
@XmlType(name = "MD_GeometricObjectTypeCode_PropertyType", namespace = "http://www.isotc211.org/2005/gmd", propOrder = {
...
public class MDGeometricObjectTypeCodePropertyType {
    ...
    /**
     * 获取mdGeometricObjectTypeCode属性的值。
     * 
     * @return
     *     possible object is
    ...
    /**
     * 设置mdGeometricObjectTypeCode属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link CodeListValueType }
