...
/**
 * <p>AirspaceVolumeType complex type的 Java 类。
 * 
...
@XmlType(name = "AirspaceVolumeType", namespace = "http://www.aixm.aero/schema/5.1.1", propOrder = {
    "upperLimit",
    "upperLimitReference",
    "lowerLimit",
    "lowerLimitReference",
    ...
    extends AbstractAIXMObjectType
{
    ...
    public static class Extension {
        ...
        @XmlElement(name = "AbstractAirspaceVolumeExtension", namespace = "http://www.aixm.aero/schema/5.1.1")
        protected AbstractExtensionType abstractAirspaceVolumeExtension;
        @XmlAttribute(name = "owns")
        protected java.lang.Boolean owns;

        /**
         * 获取abstractAirspaceVolumeExtension属性的值。
         * 
         * @return
         *     possible object is
        ...
        /**
         * 设置abstractAirspaceVolumeExtension属性的值。
         * 
         * @param value
         *     allowed object is
         *     {@link AbstractExtensionType }
