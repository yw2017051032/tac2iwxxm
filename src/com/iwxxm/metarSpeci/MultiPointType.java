...
/**
 * <p>MultiPointType complex type的 Java 类。
 * 
    ...
    extends AbstractGeometricAggregateType
{
    ...
    protected List<PointPropertyType1> pointMember;
     ...
     * 
     */
    public List<PointPropertyType1> getPointMember() {
        if (pointMember == null) {
            pointMember = new ArrayList<PointPropertyType1>();
        }
